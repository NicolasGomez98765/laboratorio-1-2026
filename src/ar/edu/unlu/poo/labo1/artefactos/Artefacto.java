...
public class Artefacto {
    ...
    private String tipoDeArtefacto;
    private Integer poder;

    public Artefacto(String nombre, Integer poder, String tipoDeArtefacto){
        this.nombre=nombre;
        this.poder=poder;
    ...
    public String getTipoDeArtefacto(){return tipoDeArtefacto;}
